...
prev.addEventListener("click",()=>{
    ...
    if(n>=1){
        ...
        //         let newtd=document.createElement("td")
        //         newtd.innerText=`${data[i][newarr[j]]}`
        //         newtr.prepend(newtd)
        //     }
        //     // let tab=document.getElementById("tab")
        //     tb.appendChild(newtr)
    ...
    if(btn1.innerText==n){
        btn1.focus()
    }else if(btn2.innerText==n){
        btn2.focus()
    }else if(btn3.innerText==n){
        btn3.focus()
    }else if(btn4.innerText==n){
        btn4.focus()
    }else{
        btn5.focus()
    }
